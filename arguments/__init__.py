...
class iComMaParams(ParamGroup):
    def __init__(self, parser):
        self.OVERLAY = True
        self.camera_pose_lr = 0.02 # learning rate
...
def get_combined_args(parser : ArgumentParser, model_path=None, source_path=None):
    ...
    for k,v in vars(args_cmdline).items():
        if v != None:
            merged_dict[k] = v
    if source_path:
        merged_dict["source_path"] = source_path
    merged_dict["eval"] = True
